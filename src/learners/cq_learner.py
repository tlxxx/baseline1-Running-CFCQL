...
class CQLearner:
    ...
    def train_behaviour(self, batch: EpisodeBatch, t_env: int ):
        ...
        if self.behaviour_train_steps - self.behaviour_log_stats_t >= 20:
            ...
            self.logger.console_logger.info("Behaviour model training loss: {}, training steps: {}, sum of timesteps: {}".format(loss.item(), self.behaviour_train_steps, t_env))
